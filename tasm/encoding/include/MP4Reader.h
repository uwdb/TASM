#ifndef TASM_MP4READER_H
#define TASM_MP4READER_H
...
public:
    ...
    std::unique_ptr<std::vector<char>> dataForSamples(unsigned int firstSampleToRead, unsigned int lastSampleToRead) const;
