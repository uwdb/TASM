    ...
    static const std::unordered_map<std::string, std::string> VideoPathToLabelsPath(
            {
                    ...
                    {"traffic-2k-001-cracked-grouping-extent-duration30", traffic_2k_db},
                    {"traffic-2k-001-cracked-grouping-extent-duration60", traffic_2k_db},
                    ...
                    {"traffic-2k-001-cracked-smalltiles-duration30", traffic_2k_db},
                    {"traffic-2k-001-cracked-smalltiles-duration60", traffic_2k_db},
                    {"traffic-2k-001-cracked-smalltiles-duration120", traffic_2k_db},
